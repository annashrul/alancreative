                            ...
                            <Col md={8}>
                                <Card>
                                    ...
                                    <Row gutter={[20,20]}>
                                        <Col md={12}>
                                            <Button
                                                onClick={()=>message.success('transaksi berhasil disimpan').then(()=>{
                                                    setTotalAmount(0)
                                                    setCart([])
                                                })}
                                                style={{width:"100%",backgroundColor:"#7CB083",border:"1px solid #7CB083",color:"white"}} disabled={cart.length===0} type={'default'}>Save Bill</Button>
                                        </Col>
                                        <Col md={12}>
                                            <ReactToPrint
